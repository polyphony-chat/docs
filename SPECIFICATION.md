...
|------------------------------------| |                                                     |                                 
                                       |                                                     |                                 
```
Fig. 7: Sequence diagram depicting the process of a client using a CSR to request a new ID-Cert from their home server.
...
|                                      |                                                      |                                                   |
```
Fig. 8: Sequence diagram depicting a successful migration of Alice_A's account to Alice_B's account, where Server A is reachable and cooperative.
...
|            |                                                                                |                                                   |
```
Fig. 9: Sequence diagram depicting a successful migration of Alice_A's account to Alice_B's account, where Server A is unreachable or uncooperative.
...
|                                                    |                                                                     |                                                     
```
Fig. 10: Sequence diagram depicting the re-signing procedure.