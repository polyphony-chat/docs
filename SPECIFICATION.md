...
| -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------- |
| The home servers' fully qualified domain name.                                               |                                                                                                 | Issuer Name                                              |
...
| The expiry date of the certificate.                                                          | Time must not be after expiry date of the home server's public key                              | Validity period: Not After                               |
| Certificate validity period starting date                                                    | Time must not be before the home server's public key was generated                              | Validity period: Not Before                              |
